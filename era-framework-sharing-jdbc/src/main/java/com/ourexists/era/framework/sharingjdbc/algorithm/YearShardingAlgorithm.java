...
public class YearShardingAlgorithm implements StandardShardingAlgorithm<Date> {
    ...
    @Override
    public String doSharding(Collection<String> collection, org.apache.shardingsphere.sharding.api.sharding.standard.PreciseShardingValue<Date> preciseShardingValue) {
