...
public class DateUtil {
     ...
     * yyyy-MM-dd HH:mm:ss
     */
    public static final String DATE_HOURS_FORMAT = "yyyy-MM-dd HH:mm";
     ...
     *
     * @param date 日期
     * @param year  年数（+：后几年，-：前几年）
     * @return Date
     */
    public static Date getWarpYear(Date date, Integer year) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
    ...
    public static Date getWarpMonth(Date date, Integer month) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
    ...
    public static Date getWarpSecond(Date date, Integer second) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
     ...
     * @return
     */
    public static List<String> getPasttwelveMonth() {
        LocalDate today = LocalDate.now();
        List<String> listMonth = new ArrayList<>();
        for (int i = 0; i < 12; i++) {
            LocalDate localDate = today.minusMonths(i);
            listMonth.add(localDate.toString().substring(0, 7));
        }
        // 将倒序改为正序
